...
# import sinastorage
from sae.extend.SinaSCS import sinastorage # important! changed by Peter on 20181017
from sinastorage.compat import six, StringIO, urllib, http_client
# from sae.extend.SinaSCS.sinastorage.compat import six, StringIO, urllib, http_client
...
# from sae.extend.SinaSCS.sinastorage.utils import (_amz_canonicalize, metadata_headers, metadata_remove_headers, 
# 					rfc822_fmtdate, aws_md5, aws_urlquote, guess_mimetype, 
# 					info_dict, expire2datetime, getSize, rfc822_parsedate, FileWithCallback)
...
class SCSBucket(object):
	...
	def __init__(self, name=None, base_url=None, timeout=None, secure=False):
		print('inside __init__ method in sae.extend.SinaSCS.sinastorage.bucket.SCSBucket ')
		# print( sinastorage )
		# print( sinastorage.getDefaultAppInfo() )
		if sinastorage.getDefaultAppInfo() is not None :
			...
			# print( self.access_key, self.secret_key, secure )
		else :
			import os
